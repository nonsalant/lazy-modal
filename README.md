...
| `close-button`   | If set to false, no close button is added. You can add a "close" button manually (inside the modal element) with something like: <br> `<button class="close-button" type="button">Close</button>` |
